                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="header-top-left">
                                <div class="hotline">
                                    <a v-if="hotline && hotline.allow_show == true" :href="'tel:+'+hotline.data">
                                    ...
                                    <form class="form-search">
                                        <div class="search-nav-left" >
                                            <select v-model="search_category" name="category" data-type="select" data-target="#search-selected-value">
                                                <option v-if="categories_is_product" selected="selected"
                                                    :value="categories_is_product.alias">
                                                    {{header_search_category.default_option}}
                                                </option>
                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="header-menu">
                                <nav class="menu" id="menu">
                                    ...
                                    <ul class="menubar" >
                                        <li class="hidden-md hidden-lg item-top-menu" v-if="!$store.state.user">
                                            <router-link to="/user/register"><i class="fas fa-user-plus"></i>Đăng ký</router-link>
                                        </li>
                                        <li class="hidden-md hidden-lg item-top-menu" v-if="!$store.state.user">
                                            <router-link to="/user/login"><i class="fas fa-sign-in-alt"></i>Đăng nhập</router-link>
                                        </li>
                                        <li v-if="$store.state.user" class="has-submenu hidden-md hidden-lg">
                                            <a href="#" v-if="$store.state.user.fullname">
                                                <i class="fa fa-user"></i>
                                                {{$store.state.user.fullname}}
                                                <i class="icon-first-submenu"></i>
                                            </a>
                                            <ul class="submenu">
                                                <li>
                                                    <router-link to="/dashboard">
