    ...
    <div>
        <section class="wrapper">
            ...
            <div v-else>
                ...
                <HomeSub v-if="$store.state.default_data && $store.state.default_data.form_subscribe && $store.state.default_data.form_subscribe.allow_show == true" 
                    :source="{ fields : $store.state.default_data.form_subscribe, setting : $store.state.default_data.form_subscribe_background }" />
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            allow_outofstock(){
                return this.source && this.source.append.allow_outofstock ? this.source.append.allow_outofstock.allow_show  : false
            },
        },
        created() {  
