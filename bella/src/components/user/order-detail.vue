<template>
    <div class="col-xs-12 col-sm-8 col-md-9">
        ...
        <router-link to="/dashboard/orders" class="btn btn-back">
...
<style>
    ...
    html .main.header-fixed .header-navbar, body .main.header-fixed .header-navbar{
        z-index: 100000;
    }
    .product-quick-view .product-info .product-name h1 {
        font-size: 18px;
        margin: 0;
        padding: 5px 0;
