                            ...
                            <div class="product-properties">
                                ...
                                <!-- <div class="product-state" v-if="source.product_type_id == '5a0d7207cba70e92b80f55b8'">
                                    <p>
                                        ...
                                        <span v-if="source.current_variant.available_quantity && source.current_variant.available_quantity > 0">
                                            Còn Hàng
                                        </span>
                                        <span v-else class="product-state-value">Hết hàng</span>
                                    </p>
                                </div>
                                <div class="product-state" v-else>
                                    <p>
                                        <span class="product-state-title">Tình trạng : </span>
                                        <span v-if="source.available_quantity && source.available_quantity > 0 ">
                                            Còn Hàng
                                        </span>
                                        <span v-else class="product-state-value">Hết hàng</span>
                                    </p>
                                ...
                                <div class="product-state" v-if="source.product_type_id == '5a052e34659d5e8445714bbd'">
                                    <p>
                                        <span class="product-state-title">Tình trạng : </span>
                                        <span v-if="source.available_quantity > 0">Còn Hàng</span>
                                    ...
                                    <div v-if="source.product_type_id == '5a052e34659d5e8445714bbd'">
                                        ...
                                        <div v-if="source.available_quantity <= 0 && source.manage_inventory == true && this.$store.state.allow_outofstock == false">
                                            <button class="btn btn-danger" @click.stop.prevent="Outofstock()">
                                                <i class="fas fa-shopping-basket"></i>Hiện đang hết hàng
                                            </button>
                                        </div>
                        ...
                        <div class="col-xs-12 product-body">
                            ...
                            <div class="tab-content product-tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="tab-product-description">
                                    <div class="page-content" v-html="source.description"></div>
                                </div>
                                        ...
                                        <div class="item-product-thumb">
                                            <div class="product-inner">
                                                ...
                                                <router-link itemprop="url" class="product-image" :to="alias(item.Alias)">
                                                    ...
                                                    <img v-else 
                                                        itemprop="image" 
                                                        :src="theme_uri + 'static/images/default/img_article.jpg'"
                                                        :alt="item.name">
                                                    <div class="product-btn-groups">
...
<style scope>
    .product-btn-groups .btn-danger {
        background: #d6020e!important;
        color: #fff!important;
    }
</style>
    ...
    export default {
        ...
        methods: {
            ...
            switchProperty(child, parent) {
                ...
                }else if( current_variant.hasOwnProperty('_id') ){
                    this.variant_id = current_variant._id;
                }
            ...
            mappingSource(new_val) {
                ...
                this.source.current_variant = current_variant
                // if( ! current_variant ){ 
                //     this.validateQuantity(this.source);
                //  }else{
                //      this.validateQuantity(this.source.current_variant);
                //  }
                this.$forceUpdate()
            },
            Outofstock() {
