<template>
    <div>
        <section class="wrapper" style="min-height: 356px;">
            <div class="section section-breadcrumb" style="background-image:url('upload/bella.iamsale.vn/slider/images/2018-07/8020_1530526598.jpg')">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
            ...
            <section id="cart-page" class="section section-cart">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12" v-if="data.length > 0">
                        ...
                        <div class="col-md-6 col-md-offset-3 col-xs-12" v-if="data.length <= 0">
                        ...
                        <div class="col-xs-12 text-right" v-if="data.length > 0">
