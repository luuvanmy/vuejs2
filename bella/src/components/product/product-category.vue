                        ...
                        <div class="col-xs-12 col-sm-8 col-md-9  section-content" id="section-content">
                            <div class="list-products">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-sm-push-6">
                                            <div class="list-btn-groups">
                                                ...
                                                <ul class="nav nav-pills" data-type="view-type" v-if="product_view && product_view.allow_show">
                                                    <li :class="product_view.data == 'grid'?'active':''">
                                                        <a @click="changTab('grid')" href="#list-product-grid" data-toggle="tab">
                                                            <i class="fas fa-th"></i>
                                                        </a>
                                                    </li>
                                                    <li :class="product_view.data == 'list'?'active':''">
                                                        <a href="#list-product-list" @click="changTab('list')" data-toggle="tab">
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-sm-pull-6">
                                            <div class="list-title" data-type="list-title" v-if="products.data.length > 5">
                                ...
                                <div class="list-products-body" id="list-product-category" data-type="list-products" style="height: auto; display: block;">
                                    <div class="tab-content" id="item-product-load">
                                        <div v-if="tab=='grid'" class="tab-pane active in fade " id="list-product-grid">
                                                            ...
                                                            <div class="product-inner">
                                                                ...
                                                                <router-link class="product-image" :to="alias(item.Alias)">
                                                                    ...
                                                                    <div class="product-btn-groups">
                                                                        <button  
                                                                            @click.stop.prevent="$store.commit('showQuickView', item)" class="btn-add-item-to-cart"></button>
                                        ...
                                        <div v-else class="tab-pane fade active in" id="list-product-list">
                                            <template v-if="products && products.data && products.data.length >0">
                                                <div class="row row-flex">
                                ...
                                <div class="list-products-body text-center" v-if="products && products.data && products.data.length <= 0">
                                    <div style="max-width: 120px;margin: auto;">
                                        <img class="img-responsive" :src="theme_uri+'static/images/icons/not-found.png'" alt="">
                                    </div>
                                    <h2>Sản phẩm hiện chưa có !!!</h2>
                                </div>
                                <div class="list-products-footer" v-if="products && products.last_page > 1">
...
<script>
    ...
    export default {
        ...
        computed:{
            ...
            product_view(){
                if(this.source && this.source.append && this.source.append.product_tab){

                    if(this.source.append.product_tab.data == 'list'){
                ...
                return this.source && this.source.append && this.source.append.product_tab ? this.source.append.product_tab : null 
            }
        },
        mounted(){
