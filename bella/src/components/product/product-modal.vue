                            ...
                            <div class="product-info">
                                <div class="product-info-inner">
                                    ...
                                    <p v-if="source.current_variant">
                                        <strong class="product-category">Đang chọn:</strong>
                                    ...
                                    <!-- //nhom -->
                                    <div class="product-state" v-if="source.product_type_id == '5a0d7270cba70e92b80f55db'">
                                        <p>
                                    ...
                                    <!-- <//combo> -->
                                    <div class="product-state" v-if="source.product_type_id == '5a0d7282cba70e92b80f55dd'">
                                        <p>
                                            <span class="product-state-title">Tình trạng : </span>
                                            <span >
                                                Còn Hàng
                                    ...
                                    <!-- <sp don> -->
                                    <div class="product-state" v-if="source.product_type_id == '5a052e34659d5e8445714bbd'">
                                        <p>
                                            <span class="product-state-title">Tình trạng : </span>
                                            <span v-if="source.available_quantity > 0">
                                                Còn Hàng
                                            </span>
                                            <span v-if="source.manage_inventory == false ">Còn hàng</span>
                                            <span v-if="source.available_quantity <= 0 && source.manage_inventory == true">hết hàng</span>
                                        </p>
                                    </div>
                                    <!-- <sp bien the> -->
                                    <div class="product-state" v-if="source.product_type_id == '5a0d7207cba70e92b80f55b8'">
                                        <p>
                                            <span class="product-state-title">Tình trạng : </span>
                                            <span v-if="source.current_variant.available_quantity > 0">
                                                Còn Hàng
                                            </span>
                                            <span v-if="source.current_variant.manage_inventory == false ">Còn hàng</span>
                                            <span v-if="source.current_variant.available_quantity <= 0 && source.manage_inventory == true">hết hàng</span>
                                        </p>
                                    </div>
                                        ...
                                        <div class="product-filter" v-if="source.properties_info && source.properties_info.length">
                                            <div v-for="(property, property_index) in source.properties_info" class="item-filter" :key="property_index">
                                                <template v-if="property.childs"> 
                                                    <span class="product-state-title product-category">{{ property.name }} : </span>
                                    ...
                                    <div class="product-btn-group text-left">
                                        <!-- nhom -->
                                        <div v-if="source.product_type_id == '5a0d7270cba70e92b80f55db'">
                                        ...
                                        <!-- combo -->
                                        <div v-if="source.product_type_id == '5a0d7282cba70e92b80f55dd'">
                                            <button v-if="source.current_variant" 
                                                :disabled="source.current_variant.quantity < 1"
                                                @click.stop.prevent="$store.commit('updateCartQuantity', { product : source.current_variant })"
                                                class="btn btn-add-item-to-cart btn-lg">
                                        ...
                                        <!-- spdon -->
                                        <div v-if="source.product_type_id == '5a052e34659d5e8445714bbd'">
                                            <div v-if="source.available_quantity > 0">
                                                <button v-if="source.current_variant" 
                                                    :disabled="source.current_variant.quantity < 1"
                                                    @click.stop.prevent="$store.commit('updateCartQuantity', { product : source.current_variant })"
                                                    class="btn btn-add-item-to-cart btn-lg">
                                            ...
                                            <div v-if="source.available_quantity <= 0 && source.manage_inventory == true && this.$store.state.allow_outofstock == false">
                                                <button class="btn btn-danger" @click.stop.prevent="Outofstock()">
                                                    <i class="fas fa-shopping-basket"></i>Hết hàng
                                                </button>
                                            </div>
                                            <div v-if="source.manage_inventory == false">
                                                <button v-if="source.current_variant" 
                                                    :disabled="source.current_variant.quantity < 1"
                                                    @click.stop.prevent="$store.commit('updateCartQuantity', { product : source.current_variant })"
                                                    class="btn btn-add-item-to-cart btn-lg">
                                            ...
                                            <div v-if="this.$store.state.allow_outofstock == true && source.available_quantity <= 0 && source.manage_inventory == true">
                                                <button v-if="source.current_variant" 
                                                    :disabled="source.current_variant.quantity < 1"
                                                    @click.stop.prevent="$store.commit('updateCartQuantity', { product : source.current_variant })"
                                                    class="btn btn-add-item-to-cart btn-lg">
                                        ...
                                        <!-- bien the -->
                                        <div v-if="source.product_type_id == '5a0d7207cba70e92b80f55b8'">
                                            <div v-if="source.current_variant.available_quantity > 0">
                                                <button v-if="source.current_variant" 
                                                    :disabled="source.current_variant.quantity < 1"
                                                    @click.stop.prevent="$store.commit('updateCartQuantity', { product : source.current_variant })"
                                                    class="btn btn-add-item-to-cart btn-lg">
                                            ...
                                            <div v-if="source.current_variant.manage_inventory == false ">
                                                <button v-if="source.current_variant" 
                                                    :disabled="source.current_variant.quantity < 1"
                                                    @click.stop.prevent="$store.commit('updateCartQuantity', { product : source.current_variant })"
                                                    class="btn btn-add-item-to-cart btn-lg">
                                            ...
                                            <div v-if="source.current_variant.available_quantity <= 0 && source.manage_inventory == true && this.$store.state.allow_outofstock == false">
                                                <button class="btn btn-danger" @click.stop.prevent="Outofstock()">
                                                    <i class="fas fa-shopping-basket"></i>Hết hàng
                                                </button> 
                                            </div>
                                            <div v-if="this.$store.state.allow_outofstock == true && source.current_variant.available_quantity <= 0 && source.current_variant.manage_inventory == true">
                                                <button v-if="source.current_variant" 
                                                    :disabled="source.current_variant.quantity < 1"
                                                    @click.stop.prevent="$store.commit('updateCartQuantity', { product : source.current_variant })"
                                                    class="btn btn-add-item-to-cart btn-lg">
    ...
    export default {
        ...
        methods : {
            ...
            validateQuantity(obj ){
                if( this.$store.state.allow_outofstock  ){
                    return;
                }
                var current_quantity = obj.hasOwnProperty("quantity") && ! isNaN(obj.quantity) ? parseFloat(obj.quantity) : 0;
                if( current_quantity > obj.available_quantity ){
                    obj.quantity = obj.available_quantity;
                    this.showNotification('sản phẩm hiện đang hết hàng!!', 'error', 'danger' ) 
                }
            },
            Outofstock() {
                this.showNotification('sản phẩm hiện đang hết hàng!!', 'error', 'danger' ) 
        ...
        watch:{
            source(new_val){
                if( !new_val ){ return }
                if( new_val && (! new_val.hasOwnProperty('quantity') || isNaN( new_val.quantity ) ) ){ new_val.quantity = 0 }
